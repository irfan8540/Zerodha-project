    ...
    return ( 
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                ...
                <h4 className=''><i class="fa fa-plus-circle fa-lg" aria-hidden="true"></i>Account Opening</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className=''><i class="fa fa-folder-o" aria-hidden="true"></i> Funds </h4>
                ...
                <a href='' style={{textDecoration: "none", lineHeight: "2.5"}}></a> <br />
                <a href='' style={{textDecoration: "none", lineHeight: "2.5"}}></a> <br />
                </div>
                <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className=''><i class="fa fa-check-circle" aria-hidden="true"></i> Console</h4>
